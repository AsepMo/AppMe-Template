...
public class CrashHandler {
    ...
    public static void init(Application app) {
        init(app, app.getApplicationContext().getExternalFilesDir("analytics").getAbsolutePath());
    }
    ...
    public static void init(final Application app, final String crashDir) {
        Thread.setDefaultUncaughtExceptionHandler(new UncaughtExceptionHandler(){
                ...
                private void tryUncaughtException(Thread thread, Throwable throwable) {
                    ...
                    gotoCrashActiviy: {
                        Intent intent = new Intent(app, ApplicationCrashHandler.class);
                        intent.addFlags(
                            Intent.FLAG_ACTIVITY_NEW_TASK
                            | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK
                        );
                        intent.putExtra(ApplicationCrashHandler.EXTRA_CRASH_INFO, errorLog);
                        try {
