package com.appme.story.engine.app.folders.preview;
...
public class IconPreview {
    ...
    public static void getFileIcon(File file, final ImageView icon) {
        if (FileScanningPreference.showThumbnail() & isvalidMimeType(file)) {
    ...
    private static void loadFromRes(final File file, final ImageView icon) {
        ...
        if (file != null && file.isDirectory()) {
            ...
            final String fileExt = FileMe.getFileExtension(file.getName());
